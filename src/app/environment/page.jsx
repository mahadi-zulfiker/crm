  ...
  const environmentalCommitments = [
    {
      ...
      summary:
        "Implementing eco-friendly practices across our own operations, from energy consumption to waste management.",
    ...
    },
    {
      ...
      summary:
        "Actively working to minimize our carbon emissions and supporting clients in their decarbonization journeys.",
    ...
    },
    {
      ...
      summary:
        "Focusing on reducing water usage, promoting recycling, and optimizing resource consumption.",
    ...
    },
    {
      ...
      summary:
        "Collaborating with eco-conscious suppliers and partners who share our vision for a sustainable future.",
  ...
  const environmentalServices = [
    {
      ...
      description:
        "Conducting thorough evaluations to understand and mitigate ecological footprints.",
      link: "/services/eia",
    },
    {
      id: 2,
      ...
      description:
        "Advising businesses on integrating sustainable practices into their core strategies.",
    ...
    },
    {
      ...
      description:
        "Developing efficient waste reduction, reuse, and recycling programs.",
    ...
    },
    {
      ...
      description:
        "Assisting organizations in adopting cleaner energy sources for their operations.",
      ...
      <main className="flex-grow container mx-auto px-6 py-12">
        ...
        <section className="text-center mb-16 bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
            At Demand Recruitment, we believe that environmental responsibility
            is not just a corporate duty, but a fundamental pillar for long-term
            success and a healthier planet. Our commitment extends beyond our
            operations, influencing how we advise our clients and contribute to
            a greener economy.
          </p>
          <Link
            href="/contact"
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-semibold text-gray-700 mb-8 text-center">
            How We Support Environmental Stewardship for Our Clients
          </h2>
        ...
        <section className="text-center bg-orange-100 p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">
            The Advantages of Embracing Green Initiatives
          </h2>
          <ul className="list-disc list-inside text-gray-700 text-left max-w-2xl mx-auto mb-6 space-y-2">
            ...
            <li>
              Attraction and retention of top talent who value sustainability.
            </li>
