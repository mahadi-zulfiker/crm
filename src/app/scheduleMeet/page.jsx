    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          ...
          text: `Thank you, ${
            formData.name
          }. Your meeting is set for ${new Date(
            formData.meetingDate
          ).toDateString()} at ${formData.meetingTime}.`,
        });
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center flex-1 p-6 lg:p-12 max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-1/2 p-4">
          <img
            src={img.src}
            alt="Meeting"
            className="rounded-lg shadow-lg w-full h-auto opacity-80"
          />
        </div>
        ...
        <div className="w-full lg:w-1/2 bg-white rounded-lg shadow-lg p-6 lg:p-12">
          <h2 className="text-3xl font-semibold text-center mb-4">
            B2B Call with Demand Recruitment
          </h2>
          ...
          <p className="text-center text-sm text-gray-500 mb-6">
            All times are in (UTC+06:00) Dhaka
          </p>
          ...
          <div className="text-center mt-6">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-3 bg-orange-500 text-white font-medium rounded-lg hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
