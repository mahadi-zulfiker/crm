...
const selectedServices = [
  {
    ...
    image: "/1111.jpg",
    description: "Maintain a safe, sanitary, and welcoming environment for staff and visitors.",
  },
  {
    name: "Engineering & Maintenance",
    link: "/engineeringConstruction",
    image: "/services/2.jpg",
    description: "Ensure optimal operation of infrastructure with our expert engineering services.",
  },
  {
    name: "Integrated Facilities Management",
    link: "/facilitiesTransformation",
    image: "/services/9.jpg",
    description: "Streamline operations with a holistic approach to facilities management.",
  },
];
  ...
  return (
    <>
      ...
      <div className="text-center pt-16">
        <h1 className="text-5xl font-extrabold text-gray-800">Facility Management</h1>
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {selectedServices.map((service, idx) => (
            <div key={idx} className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 flex flex-col">
