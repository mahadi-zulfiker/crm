...
const CaseStudiesPage = () => {
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge:
        "Addressing critical staffing shortages and fluctuating demand.",
      solution:
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-grow container mx-auto px-6 py-12">
        ...
        <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto mb-10">
          Discover how Demand Recruitment Services has helped various
          organizations overcome their challenges and achieve success.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {caseStudies.map((study) => (
            <div
              key={study.id}
              className="bg-white rounded-xl shadow hover:shadow-lg overflow-hidden transition-all duration-300 flex flex-col md:flex-row h-full"
            >
              ...
              <div className="p-6 flex flex-col justify-between md:w-2/3">
                <div>
                  ...
                  <ul className="text-sm text-gray-600 space-y-1 mb-4">
                    <li>
                      <strong className="text-teal-600">Challenge:</strong>{" "}
                      {study.challenge}
                    </li>
                    <li>
                      <strong className="text-teal-600">Solution:</strong>{" "}
                      {study.solution}
                    </li>
                    <li>
