    ...
    const recentPodcasts = [
        {
            ...
            date: "May 28, 2025",
            summary: "Tune in as we discuss how artificial intelligence is reshaping the recruitment landscape and what it means for your career.",
        ...
        },
        {
            ...
            date: "May 20, 2025",
            summary: "Our experts share invaluable tips and strategies for successfully managing career changes and finding your next opportunity.",
        ...
        },
        {
            ...
            date: "May 12, 2025",
            summary: "Learn why employer branding is crucial in today's competitive market and how to build a strong brand to attract the best talent.",
    ...
    const featuredVideos = [
        {
            ...
            date: "April 10, 2025",
            summary: "Watch our comprehensive workshop on refining your interview skills to make a lasting impression.",
        ...
        },
        {
            ...
            date: "March 25, 2025",
            summary: "Get an inside look at what recruiters really look for in a resume and how to make yours stand out.",
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <main className="flex-grow container mx-auto px-6 py-12">
                <h1 className="text-4xl font-bold text-gray-800 text-center mb-12">Podcasts & Videos</h1>

                {/* Recent Podcasts Section */}
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-8">Recent Podcasts</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {recentPodcasts.map((podcast) => (
                            <div key={podcast.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                ...
                                <div className="p-6">
                                    ...
                                    <Link href={podcast.link} className="text-orange-500 hover:text-orange-600 font-medium transition-colors">
                                        Listen Now &rarr;
                                    </Link>
                                </div>
                            </div>
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-semibold text-gray-700 mb-8">Featured Videos</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {featuredVideos.map((video) => (
                            <div key={video.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                                ...
                                <a href={video.videoUrl} target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-600 font-medium transition-colors">
                                    Watch Now &rarr;
                                </a>
                            </div>
                        ))}
                ...
                <section className="text-center bg-gray-200 p-8 rounded-lg">
                    ...
                    <p className="text-gray-600 mb-6">
                        Dive deeper into our extensive library of podcasts and videos for expert insights, career advice, and industry trends.
                    </p>
