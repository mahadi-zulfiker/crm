...
const selectedServices = [
  {
    ...
    description: "Comprehensive staffing support across healthcare, cleaning, security, hospitality, and more."
  },
  {
    name: "Workforce Management",
    link: "/workforceManagement",
    image: "/services/1.jpg",
    description: "Efficient solutions for scheduling, monitoring, and optimizing workforce productivity across sectors."
  },
  {
    name: "Recruitment Solutions",
    link: "/recruitmentProcessOut",
    image: "/services/2.jpg",
    description: "Custom recruitment strategies to meet unique staffing demands for short- or long-term engagements."
  }
];
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-100 px-6 text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">Our Key Recruitment Services</h1>
        <p className="text-gray-600 text-lg">Focused solutions for modern workforce challenges</p>
      </section>
