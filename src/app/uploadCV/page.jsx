        ...
        <div>
            ...
            <div className="bg-gray-50 min-h-screen py-12 px-4">
                <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-8">
                    <h1 className="text-3xl font-bold mb-2 text-gray-800 text-center">Upload Your CV</h1>
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Interested Category (Optional)</label>
                                <input
                                    type="text"
                                    name="category"
