      ...
      <main className="text-gray-800">
        ...
        <section className="relative bg-[url('/services/43.jpg')] bg-cover bg-center text-white py-24 text-center px-4">
          ...
          <div className="relative max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold drop-shadow-lg">Engineering & Construction Recruitment</h1>
        ...
        <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-16">
            {/* Introduction */}
            <div>
              <h2 className="text-3xl font-bold mb-6 text-center">Tailored Recruitment Solutions for Engineering & Construction</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gray-100 p-6 rounded-xl shadow-md">
                  <p>
                    We specialize in sourcing and placing qualified engineers, project managers, skilled trades, and
                    construction workers to meet the evolving needs of your projects.
                  </p>
                </div>
                <div className="bg-gray-100 p-6 rounded-xl shadow-md">
                  <p>
                    Our recruitment process focuses on quality, safety compliance, and cultural fit, ensuring your team
            ...
            <div className="bg-gray-50 py-8 px-4 rounded-xl shadow">
              <h2 className="text-3xl font-bold mb-8 text-center">Why Choose Our Recruitment Services</h2>
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { title: 'Skilled Workforce Access', desc: 'Wide network of vetted engineering and construction professionals.' },
                  { title: 'Safety & Compliance Focus', desc: 'Strict adherence to industry safety and regulatory standards.' },
                  { title: 'Flexible Staffing Options', desc: 'Permanent, temporary, and contract placements tailored to project needs.' },
                  { title: 'Project Management Expertise', desc: 'Recruitment support for complex engineering and construction roles.' },
                  { title: 'Timely Hiring', desc: 'Rapid response to staffing demands to keep your project on schedule.' },
                  { title: 'Cost-Effective Solutions', desc: 'Streamlined hiring processes that reduce overheads.' },
                ].map(({ title, desc }, idx) => (
            ...
            <div className="bg-gray-100 py-10 px-6 rounded-xl shadow">
              ...
              <p className="text-center text-gray-600 mb-8">
                Whether you need skilled engineers or construction specialists, we’re here to help you build success.
              </p>
