  ...
  return (
    <div className="bg-white">
      ...
      <section className="text-center py-16 px-6 max-w-3xl mx-auto text-gray-700">
        ...
        <p className="mt-5">
          Refer them to Associated Staffing! Some of our best hires come from
          referrals. If you know someone who would be a good fit for Associated
          Staffing, we’d love to talk to them. You could earn $60 and the
          payouts are unlimited. Please provide their information using the form
          below and we’ll contact them!
        </p>
      </section>
      {/* Form Section */}
      <section className="pb-16 px-6 max-w-3xl mx-auto">
        ...
        <form className="grid grid-cols-1 gap-6">
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-white text-lg py-3 rounded-md font-semibold"
          >
            Submit Referral
          </button>
        </form>
      ...
      <section className="mb-10 text-center px-6 max-w-3xl mx-auto text-gray-700">
        <p className="mt-5">
          ...
          from Associated Staffing for updates, promotions and important
          information. Message and data rates may apply. You can opt out at any
          time by replying ‘STOP’ to our messages. For more information, please
