        ...
        <div className="bg-white">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-gray-700 relative text-white py-24 text-center overflow-hidden">
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold text-white mb-4">Request a Callback</h1>
            ...
            <section className="py-16 px-6 max-w-4xl mx-auto">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Request Callback</h2>
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <input type="text" placeholder="Company" className="border p-3 rounded-md" />
                    <input type="text" placeholder="Telephone" className="border p-3 rounded-md" />
                    <input type="text" placeholder="Job Title" className="border p-3 rounded-md" />
                    <select className="border p-3 rounded-md" defaultValue="">
                        <option value="" disabled>Nearest Office Location</option>
            ...
            <section className="py-16 px-6 bg-gray-50 text-center">
                ...
                <p className="text-gray-700 max-w-2xl mx-auto mb-6">We partner with businesses across industries to find top talent and deliver customized recruitment solutions.</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-gray-800">
                    <div className="bg-white p-6 rounded-md shadow-md">
                        <h3 className="font-semibold text-lg mb-2">Specialist Consultants</h3>
                    ...
                    <div className="bg-white p-6 rounded-md shadow-md">
                        ...
                        <p>Flexible hiring options for permanent, contract, or temporary roles.</p>
                    </div>
                    <div className="bg-white p-6 rounded-md shadow-md">
                        <h3 className="font-semibold text-lg mb-2">Extensive Network</h3>
                        <p>Access a broad network of qualified professionals ready to make an impact.</p>
                    </div>
                </div>
            </section>
