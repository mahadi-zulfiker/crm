        ...
        <>
            ...
            <section className="py-16 bg-white px-6 lg:px-20" data-aos="fade-up">
                ...
                <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                    We’re more than just recruiters – we’re your workforce partners, helping you scale, hire, and retain the best talent faster.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg text-center" data-aos="fade-up" data-aos-delay="100">
                        <div className="text-indigo-600 text-4xl mb-4">🤝</div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Tailored Recruitment</h3>
                        <p className="text-gray-600 text-sm">
                            Customized staffing solutions that match your company culture, goals, and growth needs.
                        </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg text-center" data-aos="fade-up" data-aos-delay="200">
                        <div className="text-indigo-600 text-4xl mb-4">⚡</div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Fast Turnaround</h3>
                        <p className="text-gray-600 text-sm">
                            Swift recruitment process ensures minimal downtime and quick access to top candidates.
                        </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg text-center" data-aos="fade-up" data-aos-delay="300">
                        <div className="text-indigo-600 text-4xl mb-4">📊</div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Data-Driven Matching</h3>
                        <p className="text-gray-600 text-sm">
                            AI & analytics-powered candidate screening improves accuracy and job fit.
                        </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg text-center" data-aos="fade-up" data-aos-delay="400">
                        <div className="text-indigo-600 text-4xl mb-4">🌍</div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Diverse Talent Network</h3>
                        <p className="text-gray-600 text-sm">
                            Access candidates from multiple industries, backgrounds, and experience levels.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gray-100 py-16 px-6" data-aos="fade-up">
                <h2 className="text-3xl font-semibold text-center text-gray-800 mb-10">Sectors We Serve</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
                    {sectors.map((sector, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-lg font-semibold text-gray-800">{sector.label}</h3>
                        </div>
                    ))}
                </div>
            ...
            {/* Recruitment Process */}
            <section className="mt-16 animate__animated animate__fadeInUp px-10" data-aos="fade-up">
