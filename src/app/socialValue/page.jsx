      ...
      <div className="bg-gradient-to-r from-blue-900 to-gray-700 relative text-white py-24 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-white mt-5">
            We are committed to creating a positive impact on society, the
      ...
      <div className="container mx-auto px-6 py-16 animate__animated animate__fadeIn">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              We are committed to minimizing our environmental footprint. From
              sustainable sourcing to reducing waste, we’re working towards a
              greener future.
            </p>
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              We believe in empowering communities. Our initiatives are designed
              to support local programs, promote education, and foster social
              well-being.
            </p>
            <ul className="list-disc pl-6 text-gray-600">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              We are committed to sourcing materials ethically. We work with
              suppliers who share our values and prioritize fairness,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Our focus extends to the well-being of our employees and the
              broader community. We’re dedicated to promoting healthy living and
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              ...
              Our focus is on creating a workplace where everyone feels valued
              and respected.
            </p>
            <ul className="list-disc pl-6 text-gray-600">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              We’re dedicated to developing innovative solutions that address
              global challenges. From technology to community-driven solutions,
              we strive for impactful change.
            </p>
            <ul className="list-disc pl-6 text-gray-600">
        ...
        >
          ...
          <p className="text-center text-lg text-gray-600 mb-6">
            Together, we can create lasting change. Learn more about how you can
            contribute to our mission of making the world a better place.
          </p>
