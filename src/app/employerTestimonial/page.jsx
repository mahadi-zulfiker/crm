        ...
        <div className="bg-white">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-gray-700 relative text-white py-24 text-center overflow-hidden">
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold text-white mb-4">Employer Testimonials</h1>
                    <p className="font-bold text-white mb-4">
                    Hear from the businesses we’ve partnered with and see the impact of our staffing solutions.
                    </p>
                </div>
            </div>
            ...
            <section className="bg-gray-50 py-16 px-6 max-w-4xl mx-auto">
                ...
                <form className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        <label className="block font-medium mb-1">Company (will not be used in marketing materials)</label>
                        <input type="text" className="w-full border rounded-md p-3" />
                    </div>

                    <div>
                        <label className="block font-medium mb-1">Branch location that you worked with: *</label>
                    ...
                    <div>
                        <label className="block font-medium mb-1">
                            What issue(s) were you facing before you contacted us? What problem did we solve for you?
                        </label>
                        <textarea rows="3" className="w-full border rounded-md p-3" />
                    </div>
                    ...
                    <div>
                        <label className="block font-medium mb-1">
                            How much have our services affected your profits, income, time or turnover rate?
                        </label>
                        <textarea rows="3" className="w-full border rounded-md p-3" />
                    </div>
                    ...
                    <div>
                        <label className="block font-medium mb-1">
                            What specific feature(s) of our services did you appreciate the most?
                        </label>
                        <textarea rows="3" className="w-full border rounded-md p-3" />
                    </div>
                    ...
                    <div>
                        <label className="block font-medium mb-1">
                            What part of your experience makes you want to do business with us again?
                        </label>
                        <textarea rows="3" className="w-full border rounded-md p-3" />
                    </div>

                    <div>
                        <label className="block font-medium mb-1">Additional comments about your experience with us:</label>
                        <textarea rows="3" className="w-full border rounded-md p-3" />
                    </div>
