...
export default function StaffBank() {
  return (
    <>
      ...
      <Head>
        <title>
          Demand Recruitment Services Ltd – Smarter Healthcare Staffing
        </title>
        <meta
          name="description"
          content="Tailored staffing solutions to optimize your healthcare workforce."
        />
      </Head>
        ...
        <section className="relative bg-[url('/v1.jpg')] bg-cover bg-center text-white py-24 text-center px-4">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <p className="mt-4 text-xl drop-shadow-md">
              Your Partner in Smarter Healthcare Staffing
            </p>
          </div>
        </section>
          ...
          <div className="lg:col-span-3 space-y-16">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gray-100 p-6 rounded-xl shadow-md">
                  <p>
                    We work closely with your team to identify workforce
                    challenges, reduce costs, and implement strategic solutions.
                  </p>
                </div>
                <div className="bg-gray-100 p-6 rounded-xl shadow-md">
                  <p>
                    Our recruitment experts help attract, engage, and retain top
                    healthcare talent—driving performance and cost-efficiency.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 py-8 px-4 rounded-xl shadow">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  {
                    title: "Staff Bank Technology",
                    desc: "Mobile and online booking platform for easy access.",
                  },
                  {
                    title: "Talent Engagement",
                    desc: "Recruit top-tier talent and keep them motivated.",
                  },
                  {
                    title: "High Fill Rates",
                    desc: "Achieve 95%+ fill rates with 24/7 support.",
                  },
                  {
                    title: "Workforce Optimisation",
                    desc: "Smart resource matching to improve care and efficiency.",
                  },
                  {
                    title: "Cost Savings",
                    desc: "Reduce reliance on agencies to save money.",
                  },
                  {
                    title: "Data & Insights",
                    desc: "Real-time tracking and forecasting for smarter decisions.",
                  },
                  {
                    title: "Process Automation",
                    desc: "Automate onboarding, rate approvals, and payroll.",
                  },
                ].map(({ title, desc }, idx) => (
                  <div
                    key={idx}
            ...
            <div className="bg-white p-8 rounded-xl shadow">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                {[
                  {
                    text: "View a Staff Bank case study (all staffing groups)",
                    icon: FaFileAlt,
                  },
            ...
            <div className="bg-gray-100 py-10 px-6 rounded-xl shadow">
              ...
              <p className="text-center text-gray-600 mb-8">
                Need expert guidance on building or optimising your staff bank?
              </p>
              <form className="space-y-6 bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-sm text-gray-600 text-center">
                  Let’s transform your healthcare staffing together!
                </p>
              </form>
            </div>
          </div>
