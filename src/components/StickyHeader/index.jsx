        ...
        <>
            ...
            <nav
                className={`fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-xl backdrop-blur-sm
                           ...
                           ${isVisible ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-full pointer-events-none"}`}
            >
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden lg:flex items-center space-x-6">
                            <Link href="/" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                Home
                            ...
                            <Link href="/insight" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                Insights
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                            <Link href="/allJobs" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                Find a Job
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                            <Link href="/contactUs" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                Contact Us
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                            <Link href="/aboutUs" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                About Us
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                            <Link href="/referAFriend" className="relative text-white hover:text-teal-400 transition-all duration-300 font-medium group">
                                Refer
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                            ...
                            <div className="flex items-center space-x-3 ml-4">
                                <Link href="/employer" className="bg-transparent border-2 border-teal-400 text-teal-400 hover:bg-teal-400 hover:text-gray-900 px-4 py-2 rounded-lg transition-all duration-300 font-medium hover:shadow-lg hover:scale-105 transform">
                                    Employers
                                </Link>
                                <Link href="/employees" className="bg-gradient-to-r from-teal-400 to-teal-500 hover:from-teal-500 hover:to-teal-600 text-gray-900 px-4 py-2 rounded-lg transition-all duration-300 font-medium hover:shadow-lg hover:scale-105 transform">
                                    Employee
                                </Link>
                            </div>
                        </div>
