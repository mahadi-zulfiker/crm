  ...
  return (
    <div className="fixed bottom-6 right-6 md:right-10 md:bottom-10">
      ...
      <div
        ...
        className="bg-orange-500 text-white rounded-full p-4 shadow-lg cursor-pointer hover:bg-orange-600 transition"
      >
        <svg
        ...
        <div className="fixed bottom-16 right-4 md:right-10 w-72 sm:w-80 md:w-96 bg-white border border-gray-300 rounded-lg shadow-lg flex flex-col">
          ...
          <div className="p-6 bg-gray-50 border-t border-gray-300 flex items-center space-x-2 px-4">
            <input
              ...
              className="flex-1 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400"
            />
            <button
              onClick={sendMessage}
              className="px-4 py-2 bg-orange-500 text-white rounded-lg shadow-md hover:bg-orange-600 focus:outline-none"
            >
              Send
            </button>
          </div>
